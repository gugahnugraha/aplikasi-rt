<div class="card">
	<div class="body">
		<a href="<?php echo site_url('Panel_rt/simpan_surat/' . $id); ?>" class="btn btn-primary">Simpan ke PDF</a>
		...
		<div class="container" style="width: 595px;height: 842px; ">
			<center>
				...
				<div class="col-md-10">
					...
					<hr style="line-height: 111px; border-color: black">
			...
			<p style="text-align: right">
				<?php echo get_setting('kelurahan') . ", " . date('d M Y', strtotime($k['tgl_penerbitan'])); ?><br>
