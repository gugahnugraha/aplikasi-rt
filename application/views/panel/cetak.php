<div class="card">
	<div class="body">
		...
		<div class="container" style="width: 595px;height: 842px; ">
			...
			<p style="text-align: justify">Yang bertanda tangan dibawah ini <b>Ketua RT. <?php echo $rt; ?> RW. <?php echo get_setting('rw'); ?> Desa <?php echo get_setting('kelurahan') . " Kecamatan " . get_setting('kecamatan') . " Kabupaten " . get_setting('kota'); ?> </b>dengan ini menerangkan bahwa :</p>
			<center>
				<table width="70%">
					<tr>
						<td width="25%">Nama</td>
