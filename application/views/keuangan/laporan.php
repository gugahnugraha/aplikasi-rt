<div class="card">
	<div class="header"><h2>LAPORAN RT <?php echo get_rt_by_ktp($this->session->userdata('no_ktp'));?></h2></div>
	<div class="body">
		...
		<table class="table table-bordered table-striped table-hover dataTable js-basic-example">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="<?php echo site_url('Keuangan/detail/'.$a->id_laporan);?>" class="btn btn-primary">detail</a></td>
				</tr>
			<?php endforeach;?>
...
<form action="<?php echo site_url('Keuangan/tambah_laporan/');?>" method="post">
