<div class="card">
	<div class="header bg-blue">Data Pengeluaran RW</div>
	<div class="body">
		<button class="btn btn-primary" data-toggle="modal" data-target="#pengeluaran">Tambah Pengeluaran</button><br><br>
		...
		<table class="table table-hover" style="width: 100%">
			<tr class="bg-orange">
			<td>Total Pengeluaran Keseluruhan</td>
...
<form action="<?php echo site_url('RW/tambah_pengeluaran/');?>" method="post">
